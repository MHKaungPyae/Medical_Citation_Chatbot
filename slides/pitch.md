...
"Explain about paracetamol and I took glucosamine
 and now I have a rash — what is happening to me?"
     ...
     Ollama    → medgemma1.5:4b-it-q8_0 streams response token-by-token
                              ↓
...
**Stack:** FastAPI · Next.js 16 · Ollama (`medgemma1.5:4b-it-q8_0`) · Supabase · TypeScript · Tailwind

**Design:** No hardcoded prompts, no classifiers, no drug lists. LLM handles everything generatively. Drug names extracted heuristically (3-pass). 
...
`medgemma1.5:4b-it-q8_0` runs on-device via Ollama. Wikipedia and OpenFDA need no API keys. The LLM never sends your data to the cloud.
