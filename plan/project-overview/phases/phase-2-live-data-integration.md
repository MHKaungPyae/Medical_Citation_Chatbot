...
- Built RxNav/RxNorm client (`rxnav_client.py`) — later deleted (heuristic extraction sufficient)
...
- `backend/rxnav_client.py` (deleted)
- `backend/retry.py`
...
- `rxnav_client.py` — unnecessary latency, heuristic extraction sufficient
